    ...
    <div className="h-auto w-[90%] mx-auto space-y-10">
      ...
      <div className="h-auto pt-[100px] bg-[url('/fondo.png')] bg-cover">
        <div className="flex items-center justify-center h-[300px]">
          <h1
            className="text-white text-6xl px-[400px] text-center
      ...
      <section className="h-[500px] text-white px-10 grid place-content-center space-y-10">
        ...
        <p className="text-5xl font-semibold py-1">
          ——— <span className="text-degradado">Ayanokōji Kiyotaka</span>
        </p>
      </section>

      <section className="h-auto text-white flex flex-col justify-center items-center space-y-10">
        <button
          className="py-4 px-6 border border-[#6201FC] rounded-full text-[#6201FC]
          text-3xl hover:bg-[#6201fc] hover:text-white transition-all cursor-cell"
        >
          Stack Tecnológico
        </button>

        <h1 className="font-bold text-6xl text-center px-40">
        ...
        <div className="relative grid grid-cols-3 text-white gap-4 h-full w-full mb-10">
          {tecnologias.map((tec) => (
            <div className="rounded-xl border glassmorphism px-10 py-12 space-y-10">
              {tec.icono}
      ...
      <section className="text-white h-auto space-y-10 ">
        <button
          className="py-4 px-6 border border-[#6201FC] rounded-full text-[#6201FC]
          text-3xl hover:bg-[#6201fc] hover:text-white transition-all cursor-cell"
        >
        ...
        <h1 className="text-8xl font-semibold pr-[600px]">
          Ideas{" "}
          <span className="text-[#6201FC] font-normal">
        ...
        <div className="h-screen p-10 cursor-pointer">
          <img
            src="https://i.pinimg.com/736x/ae/8f/8b/ae8f8b0d835320bb0f4f6adb415332dd.jpg"
            alt="imagen"
            className="w-full h-full object-cover rounded-4xl efecto "
          />
        </div>
      </section>

      <footer className="flex flex-col text-white h-[100px] border"></footer>
    </div>
  );
}
